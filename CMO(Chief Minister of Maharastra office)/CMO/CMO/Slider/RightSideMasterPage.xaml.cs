...
namespace SlideOverKit.MoreSample
{
		...
		public void ApplicationListBinding()
		{
			...
			if (TargetPlatform.iOS == Device.OS)
			{
				...
				ApplicattionList.Add(new ApplicationData()
				{
					...
					PackageName = "in.gov.maharashtra.govtresolutions",
					Icon = "http://a1.mzstatic.com/us/r30/Purple1/v4/a2/cd/65/a2cd6530-2881-2ef3-2f0d-73b182128922/icon175x175.png",
					URL = "https://itunes.apple.com/in/app/maharashtra-govt.-resolutions/id1015385492?mt=8http://a1.mzstatic.com/us/r30/Purple1/v4/a2/cd/65/a2cd6530-2881-2ef3-2f0d-73b182128922/icon175x175.png",
					AppStatus = ""
				});
				...
				ApplicattionList.Add(new ApplicationData()
				{
					SetFontSize = App.GetFontSizeMedium(),
					Name = "FAQ",
					PackageName = "com.crystalhitech.faq",
					Icon = "http://a2.mzstatic.com/us/r30/Purple49/v4/2b/14/fc/2b14fc70-4759-e850-8fc8-a9d62b332d2d/icon175x175.png",
					URL = "https://itunes.apple.com/us/app/faqs-on-local-body-elections/id1071809672?mt=8",
					AppStatus = ""
				});
				ApplicattionList.Add(new ApplicationData()
				{
	...
	public class OpenInstallColorConverter : IValueConverter
	{
		...
		public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
		{
			...
			{
				case "install":
				return Color.FromHex("#132561");
				case "open":
				return Color.FromHex("#f47421");
			}
			return Color.Gray;
		}
